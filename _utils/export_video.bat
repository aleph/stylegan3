...
set path=00015-stylegan2-illustrazioni-h2-1024x1024-gpus1-batch32-gamma7.2
...
python ada_src/_genSGAN2.py --model "models\%path%\%model_name%" --out_dir "_out\out_SGAN2\%path%\%test_name%" --frames "90-90" --size "1080-3640" --scale_type 'symm' -n "1-2" --splitfine 0. --cubic --seed 0 --verbose
