...
def generate_images(
    ...
    # [1000, 1001, 1003, 1007, 1009, 1015, 1017, 1026, 1032, 1037, 1041, 1044, 1045], 
    # input_seed_list = [
    # [1000, 1001, 1003, 1007, 1009, 1015, 1017], 
    # [1004, 1005, 1016, 1020, 1023, 1031, 1038], 
    # [1002, 1006, 1013, 1040, 1053, 1061, 1065],
    # [1024, 1035, 1036, 1055, 1068, 1077, 1085]
    # ]

    input_seed_list = [
    [1022, 1001, 1003, 1005, 1007, 1009, 1015, 1016, 1017, 1020, 1023, 1031, 1038], 
    [1006, 1010, 1044, 1061, 1063, 1066, 220,  255,  275,  300,  329,   556, 951 ]
    ]
